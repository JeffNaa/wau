...
exports.TestpluginController = void 0;
const common_1 = require("@nestjs/common");
const testplugin_service_1 = require("./testplugin.service");
let TestpluginController = class TestpluginController {
    constructor(testpluginService) {
        this.testpluginService = testpluginService;
    }
    getStatus() {
...
exports.TestpluginController = TestpluginController;
__decorate([
    (0, common_1.Get)('status'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], TestpluginController.prototype, "getStatus", null);
__decorate([
